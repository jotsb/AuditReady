...
export SMTP_ADMIN_EMAIL="contact@auditproof.ca"
export SMTP_HOST="mail.privateemail.com"
export SMTP_PORT="587"
export SMTP_USER="contact@auditproof.ca"
export SMTP_PASS=""
export SMTP_SENDER_NAME="AuditProof"
success "SMTP configured for PrivateMail (contact@auditproof.ca)"
warning "SMTP_PASS is empty - add after deployment for security"
...
# 2. Add SMTP_PASS for PrivateMail (contact@auditproof.ca)
#    See: infrastructure-scripts/ADD_SMTP_PASSWORD.md
...
log ""
log "${YELLOW}⚠ IMPORTANT POST-DEPLOYMENT STEPS:${NC}"
log "  1. ${CYAN}Backup secrets.txt securely!${NC}"
log "  2. ${YELLOW}Add SMTP password:${NC} See ADD_SMTP_PASSWORD.md"
log "     Account: contact@auditproof.ca"
log "  3. ${YELLOW}JWT tokens${NC} (ANON_KEY, SERVICE_ROLE_KEY) are demo placeholders"
log "     Real tokens will be generated by Kong on first start"
log "  4. ${CYAN}Update JWT tokens${NC} in .env files after services start"
log ""
log "${GREEN}Next:${NC} Run ./04-configure-env.sh to create .env files"
log ""
