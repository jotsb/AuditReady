...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    -- Log to audit_logs
    INSERT INTO audit_logs (action, actor_id, resource_type, resource_id, details, status)
    VALUES (v_action, NEW.user_id, 'recovery_code', NEW.id, v_details, 'success');
  ...
  ELSIF TG_OP = 'DELETE' THEN
    ...
    -- Log to audit_logs
    INSERT INTO audit_logs (action, actor_id, resource_type, resource_id, details, status)
    VALUES (v_action, OLD.user_id, 'recovery_code', OLD.id, v_details, 'success');
