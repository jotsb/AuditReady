...
export function AuditLogEntry({ log }: AuditLogEntryProps) {
  ...
  const renderSnapshotComparison = () => {
    ...
    return (
      <div className="mt-4 border border-slate-200 dark:border-gray-700 rounded-lg overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-slate-100 dark:bg-gray-700">
              <tr>
                <th className="px-4 py-2 text-left font-medium text-slate-600 dark:text-gray-400">Field</th>
                <th className="px-4 py-2 text-left font-medium text-slate-600 dark:text-gray-400">Before</th>
                <th className="px-4 py-2 text-left font-medium text-slate-600 dark:text-gray-400">After</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
              {filteredKeys.map(key => {
                ...
                return (
                  <tr key={key} className={isChanged ? 'bg-yellow-50 dark:bg-yellow-900/20' : ''}>
                    ...
                    <td className="px-4 py-2 text-slate-600 dark:text-gray-400 font-medium">
